...
import 'mod_password_model.dart';
export 'mod_password_model.dart';

class ModPasswordWidget extends StatefulWidget {
  const ModPasswordWidget({Key? key}) : super(key: key);

  @override
  _ModPasswordWidgetState createState() => _ModPasswordWidgetState();
}

class _ModPasswordWidgetState extends State<ModPasswordWidget> {
  late ModPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModPasswordModel());
